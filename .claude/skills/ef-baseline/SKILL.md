...
- If this is a multi-repo project, remind: "Don't forget to commit wrapper repo changes (`memory-bank/testBaseline.md`, test files) separately from sub-repo changes."
