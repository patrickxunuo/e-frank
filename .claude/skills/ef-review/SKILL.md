...
**Ready for PR:**
> "Code looks good. You can create a PR now. If this is a multi-repo project, remember to also commit wrapper repo changes (`memory-bank/`) separately. If you used a worktree, remember to clean up after merge: `git worktree remove ../[name]`."
